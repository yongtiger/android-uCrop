...
public class UCropActivity extends AppCompatActivity {
    ...
    private void setImageData(@NonNull Intent intent) {
        ...
        String outputFilePath = intent.getStringExtra(UCrop.EXTRA_OUTPUT_FILE_PATH);
    ...
    protected void cropAndSaveImage() {
        ...
        mGestureCropImageView.cropAndSaveImage(mCompressFormat, mCompressQuality, new BitmapCropCallback() {
            ...
            public void onBitmapCropped(@NonNull String filePath, int offsetX, int offsetY, int imageWidth, int imageHeight) {
                setResult(filePath, mGestureCropImageView.getTargetAspectRatio(), offsetX, offsetY, imageWidth, imageHeight);
                finish();
            }
    ...
    protected void setResult(String filePath, float resultAspectRatio, int offsetX, int offsetY, int imageWidth, int imageHeight) {
