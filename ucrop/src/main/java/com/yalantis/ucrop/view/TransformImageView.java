...
public class TransformImageView extends AppCompatImageView {
     ...
     */
    public void setImage(@NonNull Uri imageUri, @Nullable String filePath) throws Exception {
        int maxBitmapSize = getMaxBitmapSize();

        BitmapLoadUtils.decodeBitmapInBackground(getContext(), imageUri, filePath, maxBitmapSize, maxBitmapSize,
